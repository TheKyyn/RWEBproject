...
class CryptocurrencyController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $cryptoDetails = [
            ...
            'price_change_percentage_7d' => isset($cryptocurrency->market_data->price_change_percentage_7d) ? $cryptocurrency->market_data->price_change_percentage_7d : null,
            ...
            'description' => isset($cryptocurrency->description->en) ? $cryptocurrency->description->en : '',
        ];
